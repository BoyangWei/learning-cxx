...
int main(int argc, char **argv) {
    ...
    }
    {
        ...
        }
        {
            ...
            std::vector<double> another(6);
            ASSERT(sizeof(vec) == sizeof(another), "Fill in the correct value.");
            vec.pop_back();
            ASSERT(vec.size() == 5, "Fill in the correct value.");
            ASSERT(sizeof(vec) == sizeof(another), "Fill in the correct value.");
        }
    ...
    }
    {
        ...
        ASSERT(sizeof(vec) == sizeof(std::vector<char>(48)), "Fill in the correct value.");
        {
